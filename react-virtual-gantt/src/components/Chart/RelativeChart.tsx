...
// const RelativeChart: React.FC<ChartProps> = ({
//   data,
//   className,
//   onBarDoubleClick,
//   onBarChange,
//   relativeMode,
// }) => {
//   const { settings, scaleDates, wrapRef, setCurrentDate } = useContext(RelGanttContext);
...
//         RelativeGanttDimensionSettings[settings.dimension].secondsInPixel
//     );
...
//       ) : (
//         <>
//           <RelativeScale width={width} wrapRef={wrapRef} ref={scaleRef} />
