import { GanttDimensions, GanttUnitOfTimes, RelativeGanttDimensions } from '../enums';
...
export const RelativeGanttDimensionSettings = {
  ...
  [RelativeGanttDimensions.MINUTE]: {
    value: 7,
    hours: 1 / 60,
    minutes: 1,
    label: '1 minute',
    unitOfTime: GanttUnitOfTimes.MINUTE,
    itemsCount: 11 * 60,
    stepWidth: GanttConsts.SCALE_STEP_DEFAULT_WIDTH / 60,
    scaleStepItems: GanttConsts.MINUTES_IN_HOUR / 1,
    secondsInPixel: (GanttConsts.SECONDS_IN_MINUTE * 1) / GanttConsts.SCALE_STEP_DEFAULT_WIDTH,
  },
  [RelativeGanttDimensions.SECOND]: {
    value: 9,
    hours: 1 / 3600,
    label: '1 second',
    unitOfTime: GanttUnitOfTimes.SECOND,
    itemsCount: 11 * 60 * 60,
    stepWidth: GanttConsts.SCALE_STEP_DEFAULT_WIDTH / (60 * 60),
    scaleStepItems: GanttConsts.SECONDS_IN_MINUTE / 1,
    secondsInPixel: 1 / GanttConsts.SCALE_STEP_DEFAULT_WIDTH,
  },
};
